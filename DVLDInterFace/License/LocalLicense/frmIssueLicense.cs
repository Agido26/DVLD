...
namespace DVLD.Driver
{
    public partial class frmIssueLicense : Form
    {
      ...
      public DataBackEvent DataBack;
        ...
        {
            LicneseID = _LocalLicense.IssueLicenseForFirstTime(txtNote.Text,clsGlobal.CurrentUser.UserID);
        ...
        private void frmIssueLicense_FormClosing(object sender, FormClosingEventArgs e)
        {
